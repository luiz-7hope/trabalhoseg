...
<main>
  ...
  <section>
    <h2>Área dos Pais</h2>
    <ul>
      <li><a href="#">Consultar boletim do aluno</a></li>
      <li><a href="#">Ver comunicados</a></li>
      <li><a href="#">Falar com professores</a></li>
    </ul>
  </section>

  <section>
    <h2>Excluir Conta</h2>
    <form method="POST" onsubmit="return confirm('Deseja realmente excluir sua conta?');">
